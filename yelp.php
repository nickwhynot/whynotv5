...
function getyelp($latitude,$longitude,$category,$radius){
//
...
$unsigned_url = "http://api.yelp.com/v2/search?sort=2&radius_filter=" . $radius . "&" . $category . "ll=" . $latitude . "," . $longitude . "";
